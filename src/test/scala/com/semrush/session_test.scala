...
class data_processor_test extends FlatSpec {
  ...
  val eventList = List[event](
    ...
    // *** SESSION ***
    event(
      server_stamp = new Timestamp(1506818711000L),
      client_stamp = new Timestamp(1506818645374L), // new session, because previous event was 40 min ago
      ...
      referer_domain = Some[String]("tripadvisor.ca"),
      status_code = 200,
      country_code = "CA",
      browser = "Chrome",
      operating_system = "Windows8.1",
